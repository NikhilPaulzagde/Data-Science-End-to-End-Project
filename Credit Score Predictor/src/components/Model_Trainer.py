...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_arr,test_arr):
        try:
            ...
            model_report:dict = evaluate_model(X_train= X_train, y_train= y_train, X_test= X_test, y_test= y_test, classifier=classifiers)
            ...
            print(f"Best model found, Model Name is {best_model_name},accuracy score : {best_model_score:.2f}")
            print("*"*90)
            ...
            logging.info("Error Found in initiate model trainer")
